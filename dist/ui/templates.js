...
exports.webPopupTemplate = webPopupTemplate;
exports.mobilePopupComponent = mobilePopupComponent;
function webPopupTemplate(params) {
    return `
<!DOCTYPE html>
<html lang="en">
<head>
...
;
function mobilePopupComponent(params) {
    return `
